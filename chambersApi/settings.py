"""
Django settings for chambersApi project.
...
ALLOWED_HOSTS = ['https://web-production-e217.up.railway.app']
...
WSGI_APPLICATION = 'chambersApi.wsgi.application'
